...
📘 See examples for [Word]({{< ref "/watermark/python-net/developer-guide/advanced-usage/adding-watermarks/add-watermarks-to-word-processing-documents/_index.md" >}}) formats
...
📘 Excel watermarking [examples]({{< ref "/watermark/python-net/developer-guide/advanced-usage/adding-watermarks/add-watermarks-to-spreadsheet-documents/_index.md" >}})
...
📘 PowerPoint watermarking [examples]({{< ref "/watermark/python-net/developer-guide/advanced-usage/adding-watermarks/add-watermarks-to-presentation-documents/_index.md" >}})
...
📘 Add watermark to [PDF]({{< ref "/watermark/python-net/developer-guide/advanced-usage/adding-watermarks/add-watermarks-to-pdf-documents/_index.md" >}})
...
📘 Add watermark to MSG [files]({{< ref "/watermark/python-net/developer-guide/advanced-usage/adding-watermarks/add-watermarks-to-email-attachments/_index.md" >}})
...
📘 Image watermarking [examples]({{< ref "/watermark/python-net/developer-guide/advanced-usage/adding-watermarks/add-watermarks-to-images/_index.md" >}})
